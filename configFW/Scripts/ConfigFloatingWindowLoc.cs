...
namespace PengoTarot.ConfigFW
{
    ...
    public static class ConfigFloatingWindowLoc
    {
        ...
        /// <summary>命运之轮动态行：显示距离下一次复制还需加入的卡牌数。</summary>
        private static string BuildWheelOfFortuneSettingsDescription()
        {
            ...
            if (player == null)
                return baseText;
            // 内部采用“初始 1、每 5 次触发”，复制牌自身占其中 1 次；
            // 对玩家展示的仍是距离下一次复制还需主动加入多少张牌。
            int remainder = ConfigFloatingWindowRunData.GetWheelOfFortuneCardCount(player.NetId) % 5;
            int cardsRemaining = 5 - remainder;
            var line = new LocString("gameplay_ui", "BAL_CFW_WHEEL_PROGRESS");
            line.Add("Count", cardsRemaining);
        ...
        private static readonly Dictionary<string, string> ChineseTexts = new()
        {
            ...
            { "BAL_CFW_FLAG_WHEELOFFORTUNE_DESC", "你每往牌组中加入[blue]4[/blue]张牌，额外加入一张与第4张相同的牌。" },
            ...
            { "BAL_CFW_WHEEL_PROGRESS", "还有[blue]{Count}[/blue]次，复制一张你加入牌组中的牌。" },
        ...
        private static readonly Dictionary<string, string> EnglishTexts = new()
        {
            ...
            { "BAL_CFW_FLAG_WHEELOFFORTUNE_DESC", "For every [blue]4[/blue] cards you add to your deck, add an extra copy of the fourth card." },
            ...
            { "BAL_CFW_WHEEL_PROGRESS", "After adding [blue]{Count}[/blue] more card(s) to your deck, the next card will be copied." },
        ...
        private static readonly Dictionary<string, string> JapaneseTexts = new()
        {
            ...
            { "BAL_CFW_FLAG_WHEELOFFORTUNE_DESC", "デッキにカードを[blue]4[/blue]枚加えるたび、4枚目と同じカードを追加で1枚加える。" },
            ...
            { "BAL_CFW_WHEEL_PROGRESS", "あと[blue]{Count}[/blue]枚デッキに加えると、次のカードが複製される。" },
        ...
        private static readonly Dictionary<string, string> KoreanTexts = new()
        {
            ...
            { "BAL_CFW_FLAG_WHEELOFFORTUNE_DESC", "덱에 카드 [blue]4[/blue]장을 추가할 때마다 네 번째 카드와 같은 카드를 1장 더 추가합니다." },
            ...
            { "BAL_CFW_WHEEL_PROGRESS", "덱에 카드를 [blue]{Count}[/blue]장 더 추가하면 다음 카드가 복제됩니다." },
