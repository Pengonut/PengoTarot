// PengoTarot/Enchantments/PlanetVenusEnchantment.cs
#nullable enable
...
{
    public sealed class PlanetVenusEnchantment : EnchantmentModel
    {
        ...
        public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
        {
            ...
            var power = ModelDb.Power<PlanetVenusPower>().ToMutable();
            if (power is PlanetVenusPower venusPower)
                venusPower.PairedPlayer = cardPlay.Target.Player;
