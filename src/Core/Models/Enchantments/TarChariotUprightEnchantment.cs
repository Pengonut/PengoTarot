...
public sealed class TarChariotUprightEnchantment : EnchantmentModel
{
    ...
    public override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay? cardPlay)
    {
        ...
        await PowerCmd.Apply<VulnerablePower>(choiceContext, targets, 1m, base.Card.Owner.Creature, base.Card);
    }
}