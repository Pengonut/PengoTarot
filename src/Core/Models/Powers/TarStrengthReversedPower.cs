...
{
    /// <summary>
    /// 占卜-力量（逆位）效果 power：挂在被力量标记的精英房间敌人身上。
    /// 敌人对玩家造成未被格挡的伤害后，给予玩家 1 层虚弱。
    ...
    /// </summary>
    public sealed class TarStrengthReversedPower : PowerModel
    {
        public override PowerType Type => PowerType.Buff;
        public override PowerStackType StackType => PowerStackType.Single;

        /// <summary>额外显示「虚弱」hovertip（该敌人对玩家造成未格挡伤害后会给玩家虚弱）。</summary>
